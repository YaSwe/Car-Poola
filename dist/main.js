    ...
    const createAccount = (accountData) => {
        ...
        request.onload = function() {
            if (request.status == 201) {
                ...
                _dom__WEBPACK_IMPORTED_MODULE_0__["default"].displayMessage('error', '');
            }
        }
    ...
    const checkLogin = (email, password) => {
        ...
        request.onload = function() {
            ...
            if (request.status == 200) {
                ...
                _dom__WEBPACK_IMPORTED_MODULE_0__["default"].changeToLoggedInUI();
            // Else 
            } else {
